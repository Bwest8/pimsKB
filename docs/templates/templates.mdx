  ...
  <table>
    <thead>
      <tr>
        ...
        <th>Reporting LEAs</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td colSpan="2"><strong>Child Accounting</strong></td>
      </tr>
      <tr>
        <td>
          <ul>
            <li>School Calendar</li>
            <li>School Calendar Fact</li>
          </ul>
        </td>
        <td>
          <ul>
            <li>School Districts</li>
            <li>Intermediate Units Career and Technical Centers (CTC)</li>
            <li>Charter Schools</li>
            <li>Private Residential Rehabilitation Institutions (PRRI)</li>
            <li>Approved Private Schools (APS)</li>
          </ul>
      ...
      <tr>
        <td colSpan="2"><strong>Discipline</strong></td>
      </tr>
      <tr>
        <td>
          <ul>
      ...
      <tr>
        <td colSpan="2"><strong>District</strong></td>
      </tr>
      <tr>
        <td>District Fact for Safe Schools</td>
        <td>
      ...
      <tr>
        ...
        <td>
          <ul>
            <li>School Districts that serve Title I students</li>
            <li>Intermediate Units that serve Title I students (see Volume 1 of the Manual for more information)</li>
            <li>Charter Schools that serve Title I students</li>
          </ul>
        </td>
      </tr>

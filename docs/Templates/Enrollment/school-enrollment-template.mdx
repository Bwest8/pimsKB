...
### 5 - ACTIVITY DATE
<p><Badge color="secondary">Optional</Badge> <Badge color="updateable" /> <Badge length={10} /></p>
...
<p><Badge color="secondary">Optional</Badge> <Badge color="updateable" /> <Badge length={6} /></p>
...
<p><Badge color="conditional">Conditionally Required</Badge> <Badge color="updateable" /> <Badge length={1} /></p>

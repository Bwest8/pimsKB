...
**(15 Fields, 9 Collected, Delimited)**
...
## Template Specifications for Safe Schools
...
See Appendix AA in Volume 2 of the PIMS User Manual for a complete list of valid values for the Category 1 – 4 fields.
</details>
...
See Appendix AA in Volume 2 of the PIMS User Manual for a description of what to include in this field.
</details>

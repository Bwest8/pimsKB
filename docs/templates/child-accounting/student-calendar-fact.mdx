...
<div class="template-info-card">
  <div class="card">
    <div class="card__header">
      <h3>(16 Fields, 15 Collected, Delimited)</h3>
      <p><strong>Target Table:</strong> <code>PIMS_STUDENT_CALENDAR_FACT</code></p>
    </div>
      ...
      <div class="load-sequence">
        ...
        <ul class="breadcrumbs">
          <li class="breadcrumbs__item">
            <Link to="/docs/templates/child-accounting/school-calendar">PIMS School Calendar</Link>
          </li>
          <li class="breadcrumbs__item">

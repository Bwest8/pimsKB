...
<div class="template-info-card">
 <div class="card">
   <div class="card__header">
     <h3>(21 Fields, 19 Collected, Delimited)</h3>
     <p><strong>Target Table:</strong> <code>PIMS_SCHOOL_CALENDAR</code></p>
   </div>
...
If `H`, Field 15 [INSTRUCTIONAL MINUTES IN STANDARD DAY](#15---instructional-minutes-in-standard-day) must be between `30` and `270`.
